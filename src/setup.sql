...
-- Create category table (Must be before project_category)
...
-- Insert exactly 5 projects for EACH of your 3 organizations (15 rows total)
...
-- Insert entry links into the bridge table
...
--Added on week05 #2 STEP 2
INSERT INTO roles (role_name, role_description) VALUES
('user', 'Standard user with basic access'), 
('admin', 'Administrator with full system access');

--Added on week05 #2 STEP 3
CREATE TABLE users ( 
